...
class _StubProvider:
    ...
    async def fetch_fixture_score(self, fixture_id, *, home_team=None, away_team=None):
...
# ---- ESPN post-event backup finisher ----------------------------------------


def _finished(home="Mexico", away="South Africa", h=2, a=0) -> ExternalScore:
    return ExternalScore(
        external_id="537327",
        home_team=home,
        away_team=away,
